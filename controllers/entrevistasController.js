...
    console.log("Fecha actual de Colombia para filtro GTE:", currentColombiaDate); // LOG 1
...
const updateInterviewAttendanceStatus = async (req, res) => {
    try {
        ...
        const allowedStatuses = ['Pendiente', 'Asistió', 'No Asistió', 'Reprogramada', 'Cancelada'];
